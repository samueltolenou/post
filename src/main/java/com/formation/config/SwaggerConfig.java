...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.formation.controller")).build().apiInfo(this.getApiInfo())
    ...
    private ApiInfo getApiInfo() {
        Contact contact = new Contact("POST BACKEND", "http://.bj/", "samuel.tolenou.perso@gmail.com");
        return new ApiInfoBuilder()
                .title("REST API FOR POST BACKEND.")
